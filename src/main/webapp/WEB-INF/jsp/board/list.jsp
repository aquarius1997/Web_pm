    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Board List Page
                <button id='regBtn' type="button" class="btn btn-xs pull-right">상품 추가</button>
            </div>
...
<%--                            <td><img src="${board.attachList[0].uploadPath}/${board.attachList[0].uuid}_${board.attachList[0].fileName}" alt=""/></td>--%>
                                <%--                            <td><img src="/resources/manage/imgs/${board.imgPath}" alt="" width="175" height="250"/></td>--%>
                            <td><a class='move' href="/board/get?pm_mno=<c:out value="${board.pm_mno}"/>">
                                <c:out value="${board.pm_title}" /></a></td>
